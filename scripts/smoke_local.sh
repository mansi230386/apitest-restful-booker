...
newman run ../collection/smoke.postman_collection.json -e ../env/local.postman_environment.json -r htmlextra --reporter-htmlextra-export $REPORT_PATH --reporter-htmlextra-title "Smoke Test"
